...
static uint16_t Revolution[5] =
{BRUSH_REVOLUTION,
SIDEBURSHL_REVOLUTION,
SIDEBURSHR_REVOLUTION,
VACUUML_REVOLUTION,
VACUUMR_REVOLUTION
};
...
//g_fVaccumLExp =500
//���g_ActulBrushVel =11760 
//���g_ActulSideBrushLVel =1480
//g_fSideBrushLExp
//
...
void BrushAndVuucControl(void)
{
    ...
    int32_t fbcnt[3] = { g_ActulBrushVel,
        g_ActulSideBrushLVel,
...
void BrushAndVuccInit(void)
{
    ...
    VuucLPid._omax = 2000;
    VuucLPid._omin = 115;
    //SetPidPra(&VuucLPid, 0.5, 0.03, 0);
    SetPidPra(&VuucLPid, 0.5, 0.02, 0);
